        ...
        <div className="w-full max-w-sm">
          <div className="mb-8">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm font-semibold text-blue-600 tracking-tight">MustBeTheSQL</span>
            </div>
            <h2 className="text-base text-slate-900 font-semibold mb-1">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            {error && (
              <div className="px-3 py-2 border border-red-200 text-red-600 text-xs rounded-md bg-red-50">{error}</div>
            )}

            {!isLoginMode && (
              <div>
                <label className="block text-[10px] uppercase tracking-wider text-slate-500 mb-1 ml-0.5 font-medium">username</label>
            ...
            <div>
              <label className="block text-[10px] uppercase tracking-wider text-slate-500 mb-1 ml-0.5 font-medium">email</label>
            ...
            <div>
              <label className="block text-[10px] uppercase tracking-wider text-slate-500 mb-1 ml-0.5 font-medium">password</label>
            ...
            <button type="submit" disabled={isLoading}
              className="btn-primary w-full py-2 text-xs font-semibold disabled:opacity-40">
